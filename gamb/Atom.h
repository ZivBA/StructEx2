...
public:
  ...
  string residueSequenceID() const;
  ...
  void setSSE(const pair<char,short>& isseInfo){sseInfo=isseInfo;}

  ////Updates SSE information
  pair<char,short> getSSE()const{return sseInfo;}
...
protected:
  ...
  string atomName;            // Four-characters string. If the name
  ...
  string resName;             // Three-characters string. The full name of the entity:
  ...
  pair<char,short> sseInfo;     // secondary structure information: char sse_type - according to SecondStruct class,
