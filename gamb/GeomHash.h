...
template<class KeyT, class DataT, class BucketT = vector<DataT> >
/*
CLASS
  GeomHash
...
template<class KeyT, class DataT, class BucketT>
void GeomHash<KeyT, DataT, BucketT>::query(const KeyT& key, const vector<float>& radii,
                                           HashResult<DataT, BucketT>& result) const
{
